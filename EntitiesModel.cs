	...
	public partial class EntitiesModel : OpenAccessContext, IEntitiesModelUnitOfWork
	{
        private static string connectionStringName
        {
            get
            {
                try
                {
                    return Utilerias.Mvx.Ioc.Resolve<IConfiguracionConexion>().CadenaConexion;
                }
                catch
                {
                    return @"SWIFT_EXPRESSConnection";
                }
            }
        }
		...
		public IQueryable<SwiftTxn> SwiftTxns 
		{
			get
			{
				return this.GetAll<SwiftTxn>();
			}
		}
