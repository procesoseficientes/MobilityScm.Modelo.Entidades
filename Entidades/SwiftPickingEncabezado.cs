...
{
    [Serializable]
    public class SwiftPickingEncabezado : ISwiftPickingEncabezado
    {
        ...
        public List<SwiftExpressPickingDetalle> SwiftExpressPickingDetalle { get; set; }

        public List<SwiftPickingSerie> SwiftPickingSeries { get; set; }
